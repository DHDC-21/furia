export default function chatResponses(userMessage) {
    ...
    if (cleanMessage.includes('help')) {
        return `
        <p>Aqui estão os comandos disponíveis para o FuriaBot:</p>
        ...
        <p>Use os comandos com sabedoria, furioso!</p>
        `;
    ...
    // Jogadores atuais do time
        ...
        return `
        <p>Os jogadores atuais da FURIA:CS são:</p>
        <ul class="list-group list-group-flush">
    ...
    // Redes sociais da FURIA
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><a href="https://www.twitch.tv/" target="_blank">Twitch</a></li>
    ...
    // Comandos diversos
    ...
    else if(cleanMessage.includes('ping')){
        return `
        Pong!
        `;
    }
        ...
        return `
        <p>Desculpe, eu não entendi sua pergunta!</p>
        <p>Use o comando <strong>help</strong> para ver todos os comandos.</p>
        `;
    }
}
